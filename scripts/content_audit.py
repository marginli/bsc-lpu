...
# 這個專題會用到的術語（換專題時改這一份）
TERMS = ["體素", "分析體素", "標籤格", "熱點", "上四分位", "五數綜合", "UPGMA", "連結法", "切割高度",
         "平台", "距離矩陣", "歐氏距離", "候選 LPU", "種子", "靶", "膨脹", "撐大", "重疊率", "等值面",
         "c 值", "距離轉換", "神經束", "Jaccard", "路徑深度", "初級神經突", "細胞本體", "族群",
         "二值化", "移動平均", "連通", "覆蓋", "滲流", "樹根", "百分位", "填洞", "形態學", "排序相關"]

# 會被讀成字面的口語／擬人詞（換專題時視領域增刪）
SLANG = ["就得有人", "挑得出人", "挑不出人", "餵進去", "爆掉", "一堆", "沒有身分", "改變身分",
         "咬人", "打架", "吞下", "隨手", "亂寫", "看圖說話", "雞蛋裡"]
